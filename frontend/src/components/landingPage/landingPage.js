              ...
              <div class='card text-center shadow'>
                ...
                <div class='card-body text-dark'>
                  ...
                  <p class='card-text text-secondary'>
                    ...
                    center of the nation’s film and television industry. Near
                    its iconic Hollywood sign, studios such as Paramount
            ...
            <div class='col-md-4'>
              <div class='card text-center shadow'>
                ...
                <div class='card-body text-dark'>
                  ...
                  <p class='card-text text-secondary'>
                    {' '}
                    San Diego is a city on the Pacific coast of California known
                    for its beaches, parks and warm climate. Immense Balboa Park
